...
<body>
    ...
    <div class="name_block">
        ...
        <div class="row">
            ...
            <select class="form-control" id="form_id" name="form_of" required>
            ...
            <option disabled selected>Предмет</option>
                ...
                <option value="Додаткові курси">Додаткові курси</option>
            </select>
            </div>
            </div>
        </div>
...
<!-- Footer section end -->
    ...
    <script>
        function check_name_test(){
            var testname = $("#testnameone").val();
            var String = 'testname='+ testname;
            $.ajax({
                type: "POST",
                url: "is_avaliable_test.php",
                data: String,
                cache: false,
                success: function(result){
                    if(result==testname)
                    {
                        alert("Тест з такою назвою вже існує");
                    }
                }
            });
        }
        ...
        {
            if($("#subject_id").val() == "Додаткові курси")
            {
